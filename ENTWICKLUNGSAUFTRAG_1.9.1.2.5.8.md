...
- Bei Verlauf und ausgewählten Diagrammen wird keine unzuverlässige automatische Querformatumschaltung versprochen. Vor dem Drucken erscheint der deutliche Hinweis, im System-Druckfenster Querformat zu wählen.
...
- Neue eindeutige Zusatzdateien `v19128.js` und `v19128.css`.
- Neuer Service-Worker-Cache `mein-begleiter-persoenlich-cache-v1-9-1-2-5-8`.
